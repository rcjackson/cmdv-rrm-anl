...
def get_PSD(filename):
    ...
    JWReader.set_scattering_temperature_and_frequency(scattering_temp=20,
                                                      scattering_freq=2.8e9)
    JWReader.set_canting_angle(12.)
    JWReader.calculate_radar_parameters(dsr_func=brandes2002)
    #except KeyError:
    #    print('No nd key!')
    #    return []
...
if __name__ == '__main__':
    #cluster = SLURMCluster(memory='64GB', cores=36, walltime='2:00:00', workers=6)
    #cluster.scale(24)
    #client = Client(cluster)
    #print('Waiting for cluster to start...')
    #while client.ncores == {}:
    #    continue
    jw_disdrometer_file_path = '/lcrc/group/earthscience/rjackson/disdrometer/filtered/twpvdis*.cdf'
    ...
    n_0 = np.ma.concatenate([x.fields['N0']['data'] for x in the_PSDs])
    ...
    print(ds)
    ds.to_netcdf('PSDs_w_radar_params_vdis_Sband.cdf')
