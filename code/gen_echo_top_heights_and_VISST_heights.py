...
# Save to netCDF file
out_netcdf = Dataset('echo_top_heights_TWP-ICE-Texturelt3.cdf', 'w')
...
z_file = out_netcdf.createVariable('z1km', tbs[0].dtype, ('time', 'x_len', 'y_len'))
z_file.long_name = 'Z at 1 km'
z_file.units = 'dBZ'
z_file[:] = tbs[2]

z_file = out_netcdf.createVariable('z5km', tbs[0].dtype, ('time', 'x_len', 'y_len'))
z_file.long_name = 'Z at 5 km'
z_file.units = 'dBZ'
z_file[:] = tbs[3]

z_file = out_netcdf.createVariable('z10km', tbs[0].dtype, ('time', 'x_len', 'y_len'))
z_file.long_name = 'Z at 10 km'
z_file.units = 'dBZ'
z_file[:] = tbs[4]

z_file = out_netcdf.createVariable('z15km', tbs[0].dtype, ('time', 'x_len', 'y_len'))
z_file.long_name = 'Z at 15 km'
z_file.units = 'dBZ'
z_file[:] = tbs[5]

dist_file = out_netcdf.createVariable('dist', tbs[0].dtype, ('time', 'x_len', 'y_len'))
dist_file.long_name = 'Distance from radar'
dist_file.units = 'dBZ'
dist_file[:] = tbs[6]
